...
/// of <see cref="DictionaryStore{TDictionary, TKey}"/> with a <see cref="int" /> as a primary key.
/// </summary>
public abstract class DictionaryStore : DictionaryStore<WarehouseDictionary, int>
{
    /// <summary>
    /// Constructs a new instance of <see cref="DictionaryStore"/>.
    /// </summary>
...
public abstract class DictionaryStore<TDictionary, TKey> : IDictionaryStore<TDictionary, TKey>
    ...
    where TKey : IEquatable<TKey>
{
    ...
    /// <summary>
    /// Constructs a new instance of <see cref="DictionaryStore{TDictionary, TKey}"/>.
    /// </summary>
    /// <param name="connector">The <see cref="IDatabaseConnector"/>.</param>
    /// <param name="errorDescriber">The <see cref="WarehouseErrorDescriber"/>.</param>
