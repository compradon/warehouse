...
namespace Compradon.Warehouse.Database
{
    ...
    /// </summary>
    public abstract class TypeStore<TWarehouseType, TKey> : ITypeStore<TWarehouseType, TKey>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="TypeStore{TWarehouseType, TKey}"/>.
        /// </summary>
        /// <param name="connector">The <see cref="IDatabaseConnector"/>.</param>
        /// <param name="errorDescriber">The <see cref="WarehouseErrorDescriber"/>.</param>
        public TypeStore(
        ...
        /// <summary>
        /// Create the specified <paramref name="warehouseType"/> in the database.
        /// </summary>
        ...
        public abstract Task<WarehouseResult> CreateAsync(TWarehouseType warehouseType, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </returns>
        public abstract Task<WarehouseResult<TWarehouseType>> FindByIdAsync(TKey key, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="WarehouseResult"/> of the operation.</returns>
        public abstract Task<WarehouseResult> UpdateAsync(TWarehouseType warehouseType, CancellationToken cancellationToken = default(CancellationToken));
