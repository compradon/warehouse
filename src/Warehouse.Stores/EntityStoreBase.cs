...
namespace Compradon.Warehouse.Stores
{
    ...
    public abstract class EntityStoreBase<TEntity, TKey> : IEntityStore<TEntity, TKey>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="EntityStoreBase{TEntity, TKey}"/>.
        /// </summary>
